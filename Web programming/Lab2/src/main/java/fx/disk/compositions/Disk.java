...
import fx.disk.compositions.cmp.CompositionComparator;
import fx.disk.compositions.cmp.Fields;
...
public class Disk implements Iterable<AbstractComposition> {
    ...
    /**
     * @return iterator for the fx.disk.compositions on the disk
     */
    @Override
    ...
    /**
     * @param field -- the field fx.disk.compositions will be sorted by
     */
