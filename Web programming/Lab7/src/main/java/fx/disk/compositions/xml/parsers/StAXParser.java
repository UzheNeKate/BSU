...
import fx.disk.compositions.Compositions;
        ...
        while (eventReader.hasNext()) {
            ...
            switch (event.getEventType()) {
                ...
                case XMLStreamConstants.END_ELEMENT -> {
                    ...
                    switch (qName) {
                        case "concert" -> disk.recordComposition(Compositions.Concert, name, duration, composer,
                                performers.get(0), tonality, null, null, instrument);
                        case "sonata" -> disk.recordComposition(Compositions.Sonata, name, duration, composer,
                                performers.get(0), tonality, null, null, null);
                        case "symphony" -> disk.recordComposition(Compositions.Symphony, name, duration, composer,
                                performers.get(0), tonality, null, null, null);
                        case "opera" -> disk.recordComposition(Compositions.Opera, name, duration, composer, performers.get(0),
                                null, textWriter, null, null);
                        case "romance" -> disk.recordComposition(Compositions.Romance, name, duration, composer,
                                performers.get(0), null, textWriter, null, null);
                        case "song" -> disk.recordComposition(Compositions.Song, name, duration, composer, performers.get(0),
