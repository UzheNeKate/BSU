...
public class LibraryController {
     ...
     */
    public LibraryController() throws DaoException {
     ...
     */
    public List GetDebtors() throws ControllerException {
        try {
    ...
    public void GiveBook(String title, String author, String reader, Date date) throws ControllerException {
        ...
        try {
            ...
            var r = readerDao.get(reader);
            logbookDao.save(new Logbook(book.getId(), r.getId(), date));
